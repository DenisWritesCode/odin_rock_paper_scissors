...
const playRound = (computerSelection, playerSelection) => { // Determine winner. 
...
const game = () => {
    ...
    let winner ='', machineWins = 0, humanWins = 0, state = '';
    for ( let i = 0; i < 5; ++i){
    ...
    return (machineWins > humanWins) ? 'Machine won' : 
            (humanWins > machineWins) ? 'Human won' : 'Tie';
}
